...
class _NoteScreenState extends State<NoteScreen> with Helpers {
  ...
  late TextEditingController _numbTextController;
  ...
  void initState() {
    ...
    _numbTextController = TextEditingController(text: widget.note?.numb);
  ...
  Note get note {
    ...
    note.numb = _numbTextController.text;
